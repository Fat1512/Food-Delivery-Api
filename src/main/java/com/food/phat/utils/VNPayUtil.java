...
public class VNPayUtil {
    ...
    public static String buildInitPaymentUrl(Map<String, String> params) {
        ...
        // 3. Build secureHash
        var secureHash = VNPayUtilTest.hmacSHA512(secretKey , String.valueOf(hashPayload));
    ...
    public static String buildReturnUrl(Integer txnRef) {
        return String.format(returnUrlFormat, txnRef);
    }

    public static String buildPaymentDetail(Integer orderId) {
        return String.format("Thanh toan don dat phong %s", orderId);
    }
